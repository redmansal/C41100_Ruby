#
# q4_family_array_loop_with_do.rb
#
# author:        Colm Nolan 
# last modified: 30 September, 2011
# description:   This file makes an array of family member objects and then it is itterated through using each so the name and status can be printed
#                do is also used for the block
